...
def calculate_angle(a, b, c):
    ...
    a = np.array([a.x, a.y])  # CORRETTO
    b = np.array([b.x, b.y])  # CORRETTO
    c = np.array([c.x, c.y])  # CORRETTO
...
def getDatasetPath():
    ...
    return os.path.join(getBasePath(), "dataset")
...
def getModelsPath():
    ...
    return os.path.join(getBasePath(), "models")
